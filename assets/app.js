 ...
 * Correção final: Recuperação automática ao recarregar com preenchimento garantido dos inputs
 */
const CONFIG = {
...
class HidrometroApp {
    ...
    atualizarUIHidrometro(id) {
        ...
        const alertaDiv = document.getElementById(`alerta-${h.id}`);
        const consumoDiv = document.getElementById(`consumo-${h.id}`);
